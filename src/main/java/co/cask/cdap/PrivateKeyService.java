...
public class PrivateKeyService extends AbstractService {

  @Override
  public void configure() {
    setName("PrivateKeyService");
    setDescription("Service to upload private key file to.");
    setInstances(1);
    addHandler(new PrivateKeyHandler());
  }

  public static class PrivateKeyHandler extends AbstractHttpServiceHandler {
    ...
    public HttpContentConsumer write(HttpServiceRequest request, HttpServiceResponder responder,
      ...
      try {
        ...
        return new HttpContentConsumer() {
          @Override
          public void onReceived(java.nio.ByteBuffer chunk, Transactional transactional) throws Exception {
            channel.write(chunk);
          }
